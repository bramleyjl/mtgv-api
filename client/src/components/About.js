      ...
      <div>
        ...
        <Grid container justify="space-around">
          <Grid item lg={6} md={8} sm={10} xs={12} className="aboutText">
            <p>
              MtG Script Automater parses text and utilizes{" "}
              ...
              a MERN stack by <a href="http://bramley.design">John Bramley</a>{" "}
              for{" "}
              <a href="https://www.youtube.com/user/TheManaSource">
                The Mana Source's
              </a>{" "}
              creator Wedge to expedite his script writing process.
            </p>
            <p>
              For full documentation and detailed instructions check out the
              project's{" "}
              <a href="https://github.com/BColsey/MTGScriptAutomater/blob/master/README.md">
                README
              </a>
              .
            </p>
